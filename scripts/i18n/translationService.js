(function initTranslationService(global) {
  ...
  const translations = {
    ...
    questRecruiterLootTitle: "Recruiter's Loot",
    questRecruiterLootDescription: "Download the CV to claim the recruiter loot.",
    questDiverTitle: "Diver",
    questDiverDescription: "Open a project modal to dive deeper.",
    questDetectiveTitle: "Private Investigator",
    questDetectiveDescription: "Visit an external social link like GitHub or LinkedIn.",
    questThemeMageTitle: "Theme Sorcerer",
    ...
    questRecruiterLootTitle: "Butin du recruteur",
    questRecruiterLootDescription: "Télécharge le CV pour récupérer le butin du recruteur.",
    questDiverTitle: "Plongeur",
    questDiverDescription: "Ouvre une modale de projet pour explorer en profondeur.",
    questDetectiveTitle: "Enquêteur privé",
    questDetectiveDescription: "Visite un lien social externe comme GitHub ou LinkedIn.",
    questThemeMageTitle: "Sorcier des thèmes",
