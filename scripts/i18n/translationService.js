(function initTranslationService(global) {
  ...
  const translations = {
    ...
    modal_whoislying_description:"In <strong>Who Is Lying</strong>, you conduct the investigation using your own voice.<br>Thanks to a seamless <strong>Speech-to-Text (STT)</strong> integration, you interrogate suspects like a real detective.<br>Test their alibis: you can ask them <strong>any question you want</strong>, with <strong>no predefined dialogue paths</strong>.<br><br>🕵️ <strong>A living memory, not a fixed script</strong><br>The suspects do not follow a script.<br>Each character is powered by an evolving <strong>Retrieval-Augmented Generation (RAG)</strong> system, giving them their own memory and knowledge base of the events.<br>If they contradict themselves or lie, it is the result of the AI’s <strong>logical reasoning</strong> in response to your questions.<br>Nothing is linear: <strong>the AI independently decides its line of defense</strong>.<br><br>⚖️ <strong>Break the suspect</strong><br>Keep an eye on the stress meter: it updates in real time based on the relevance and pressure of your interrogation.<br>A cornered suspect may eventually betray themselves.<br>To assist you, a <strong>smart investigation journal</strong> automatically extracts key information from the dialogues and archives it, allowing you to confront statements later on.<br><br>⚡ <strong>A real-time technical achievement</strong><br>At the core of this prototype lies its reactivity.<br>The entire loop, from your spoken question to the suspect’s voiced response via a <strong>Large Language Model (LLM)</strong> and <strong>Text-to-Speech (TTS)</strong> synthesis, runs in <strong>under 2 seconds</strong>.<br>No cuts, no tricks: this is a pure, real-time interaction that redefines narrative immersion.<br><br>🧩 <strong>Your mission?</strong><br>Build on their words, uncover inconsistencies, and finally discover <strong>who set the cabin on fire</strong>.",
    modal_whoislying_badge_alone: "Made alone",
    modal_whoislying_badge_date: "Jan 2026",
    ...
    // Quest system
    questButtonLabel: "Quest Log",
    questLogTitle: "Quest Journal",
    ...
    questRecruiterLootDescription: "Don’t leave empty-handed—download the CV, it’s free!",
    questDiverTitle: "Professional curiosity",
    questDiverDescription: "Click a project card; it’s like reading the README, but better.",
    questDetectiveTitle: "Stalker 2.0",
    questDetectiveDescription: "Visit the LinkedIn profile (no premium, so no one will know).",
    questThemeMageTitle: "Day / Night",
    questThemeMageDescription: "Change the lighting for a healthier circadian rhythm.",
    questPolyglotTitle: "Flex international",
    questPolyglotDescription: "Change the site language like the bilingual champ you are.",
    ...
    modal_whoislying_description: "Dans <strong>Who Is Lying</strong>, vous menez l'enquête en utilisant votre propre voix.<br> Grâce à une intégration fluide du <strong>Speech-to-Text (STT)</strong>, vous interrogez les suspects comme un véritable détective.<br> Testez leurs alibis : vous pouvez leur poser toutes les questions que vous voulez, <strong>sans aucune limite de scénario</strong>.<br><br> 🕵️ <strong>Une mémoire vivante, pas de scénario figé</strong><br> Les suspects ne lisent pas un script.<br> Chaque personnage est alimenté par un système de <strong>Retrieval-Augmented Generation (RAG)</strong> évolutif qui lui confère une mémoire propre et une base de connaissances sur les événements.<br> S'ils se contredisent ou s'ils mentent, c'est le résultat d'une <strong>analyse logique de l'IA</strong> en fonction de vos questions.<br> Rien n'est linéaire : <strong>l'IA décide seule de sa ligne de défense</strong>.<br><br>⚖️ <strong>Faites craquer le suspect</strong><br> Surveillez la jauge de stress : elle évolue en temps réel selon la pertinence et l'agressivité de vos interrogatoires.<br> Un suspect acculé peut finir par se trahir.<br> Pour vous aider, un <strong>carnet d'enquête intelligent</strong> extrait automatiquement les informations clés de vos dialogues et les archive pour que vous puissiez confronter les affirmations plus tard.<br><br>⚡ <strong>Une prouesse technique en temps réel</strong><br> Le cœur de ce prototype réside dans sa réactivité.<br> La boucle complète, de votre question orale jusqu'à la réponse vocale du suspect via un <strong>modèle de langage (LLM)</strong> et une synthèse <strong>Text-to-Speech (TTS)</strong>, s'exécute en <strong>moins de 2 secondes</strong>.<br> Aucune coupure, aucune triche : c'est une interaction pure, à la volée, qui redéfinit l'immersion narrative.<br><br>🧩 <strong>Votre mission ?</strong><br> Rebondir sur leurs propos, débusquer les incohérences et découvrir enfin <strong>qui a mis le feu à la cabane</strong>.",
    ...
    // Système de quêtes
    questButtonLabel: "Journal de quêtes",
    questLogTitle: "Journal de quêtes",
    questProgressLabel: "Progression des quêtes",
    ...
    questDetectiveTitle: "Stalker 2.0",
    questDetectiveDescription: "Visitez mon profil LinkedIn (je ne suis pas premium, je ne serai pas mis au courant, promis)",
    questThemeMageTitle: "Jour / Nuit",
    questThemeMageDescription: "Changez l’éclairage pour un meilleur cycle circadien (j'ai du vocabulaire).",
    questPolyglotTitle: "Flex international",
    questPolyglotDescription: "Changez la langue du site car vous êtes bilingue et ça c'est la classe.",
    questFPatternTitle: "Briseur de F-pattern",
    questFPatternDescription: "Scrollez plus bas que 80% des visiteurs.",
    ...
    questSecretLockedHint: "Terminez les autres quêtes pour dévoiler cette quête cachée.",
