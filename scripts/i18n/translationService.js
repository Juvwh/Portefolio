(function initTranslationService(global) {
  ...
  const translations = {
    ...
    questDiverDescription: "Clique sur un projet. C’est comme lire le README, mais en mieux.",
    questDetectiveTitle: "Stalker 2.0",
    questDetectiveDescription: "Visite mon profil LinkedIn (je ne suis pas premium, je ne serai pas mis au courant, promis)",
    questThemeMageTitle: "Jour / Nuit",
    questThemeMageDescription: "Change l’éclairage pour un meilleur cycle circadien (j'ai du vocabulaire).",
    questPolyglotTitle: "Flex international",
    questPolyglotDescription: "Change la langue du site car tu es bilingue et ça c'est la classe.",
