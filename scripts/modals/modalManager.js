(function initModalManager(global) {
  ...
  cacheDomReferences() {
    ...
    this.modalCard = this.modalOverlay ? this.modalOverlay.querySelector('.modal__card') : null;
    ...
    this.modalVideoIframe = this.modalOverlay.querySelector('.modal__video iframe');
    this.modalImageElement = this.modalOverlay.querySelector('#modal-image-element');
    this.modalVideoContainer = this.modalOverlay.querySelector('.modal__video');
  ...
  handleBodyClick(event) {
    const triggerButton = event.target.closest('[data-modal-id]');
    if (!triggerButton) {
      return;
    }
  ...
  populateGallery(data) {
    ...
    data.gallery.forEach((item, index) => {
      ...
      imgEl.alt = altText;
      imgEl.className = 'modal__gallery-image';
  ...
  populateButtons(data) {
    ...
    if (data.playUrl) {
      ...
      playButton.className = 'button modal__play-button';
    ...
    if (data.defenceUrl) {
      ...
      defenceButton.className = 'button';
